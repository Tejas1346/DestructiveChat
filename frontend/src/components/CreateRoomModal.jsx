...
const CreateRoomModal = ({open,onOpenChange}) => {
  ...
  return (
    ...
    <Dialog open={open} onOpenChange={onOpenChange} className='min-w-4xl w-auto overflow-auto'>
            ...
            <div>
              ...
              <Input className="mt-1" value={roomName}
            ...
            <div className='bg-amber-100 p-3 rounded-lg'>
              <p className='text-amber-800 text-lg'>The room will automatically expire after 30 mins.All messages will be lost after that</p>
            </div>
            <DialogFooter className='flex w-full justify-around'>
                
                    <DialogClose asChild>
                    <Button variant="outline" className="flex-1 lg:p-5 lg:text-lg">Cancel</Button>
                    </DialogClose>
                    <Button onClick={handleSubmit} className="flex-1 lg:p-5 lg:text-lg">Submit</Button>
